...
class ElasticsearchContentBaseRecommender(Recommender):
    ...
    def initiate(self):
        ...
        if not es_table_created:
            elasticsearch_factory.recreate_index_mapping(settings.ES_RECOMMEND_USER, ESRecommendUtils.get_index_mapping())

            # Load data into Table:
            ESRecommendUtils.load_data_into_es_table()
    ...
    def recommendation_logic(self):
        ...
        for profile in all_profiles:
            ...
            """
            es_query_result = ESRecommendUtils.es_content_based_recommendation(profile_id, self.RESULT_SIZE)
            ...
            if es_query_result['hits']['total'] == 0:
                ...
                if not performed_search_request:
                    ...
                    new_user_return_list = ESRecommendUtils.new_user_return_list(int(self.RESULT_SIZE / 2))
...
class ElasticsearchUserBaseRecommender(Recommender):
    ...
    def recommendation_logic(self):
        ...
        for profile in all_profiles:
            ...
            recommended_items = ESRecommendUtils.es_user_based_recommendation(profile_id)
